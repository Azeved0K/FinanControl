...
import {LayoutDashboard, ArrowLeftRight, LogOut, Menu, X, TrendingUp, FolderOpen, PiggyBank} from 'lucide-react';
...
export default function Sidebar({currentView, setCurrentView}) {
    ...
    const menuItems = [
        ...
        {id: 'piggybanks', label: 'Cofrinhos', icon: PiggyBank},
    ];
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="px-4 py-6 border-b border-gray-200 dark:border-gray-700 mt-16 lg:mt-0">
                        <button
                            ...
                            className="w-full flex items-center space-x-3 text-left rounded-lg p-2 -m-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                        >
