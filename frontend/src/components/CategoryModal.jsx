...
export default function CategoryModal({category, onClose, onCategoryAdded, defaultType}) {
    ...
    useEffect(() => {
        if (category) {
            ...
            setFormData((p) => ({...p, type: defaultType || p.type}));
        }
    ...
    return (
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 modal-overlay ${closing ? 'modal-out' : ''}`}>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto hide-scrollbar modal-panel">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-4 sm:grid-cols-5 gap-2 max-h-64 overflow-y-auto hide-scrollbar p-2 border border-gray-200 dark:border-gray-600 rounded-lg">
